...
% Text Node
\draw (48.5,123.6) node [anchor=south east] [inner sep=0.75pt]  [font=\scriptsize,color={rgb, 255:red, 65; green, 117; blue, 5 }  ,opacity=1 ]  {$\pi /2$};
% Text Node
\draw (82.5,147.9) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize,color={rgb, 255:red, 65; green, 117; blue, 5 }  ,opacity=1 ]  {$\pi /2$};
% Text Node
\draw (92.5,113.6) node [anchor=south west] [inner sep=0.75pt]  [font=\scriptsize,color={rgb, 255:red, 126; green, 211; blue, 33 }  ,opacity=1 ]  {$\pi /2$};
% Text Node
\draw (58.25,149.75) node [anchor=east] [inner sep=0.75pt]  [font=\scriptsize,color={rgb, 255:red, 126; green, 211; blue, 33 }  ,opacity=1 ]  {$\pi /2$};
% Connection
\draw    (102,295.5) -- (165.5,295.5) ;
